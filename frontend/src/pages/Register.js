...
export default function Register() {
    ...
    return <div className="w-full over-flow-[auto] flex justify-center items-center min-h-[100vh] bg-[#ffd6e7]">
        <Card style={cardStyle} className="over-flow-[auto]">
            ...
            >
                ...
                <div className="flex w-[100%] justify-center items-center ">
                    <Button
                        className={`bg-[blue] text-white mt-3 ${otpToggle ? "hidden" : "block"} `}
