...
//         <div className="bg-black w-[400px] h-full mb-[20px]">
...
//                     <span className='ml-[220px] font-bold text-white'>Best regards</span>
//                     <p>
//                         <span className='font-bold text-xl text-blue-800'>{moment().format('DD-MMM-YYYY')}</span>
//                         <span className='ml-[150px] font-bold text-xl text-blue-800'>Gramin Vikas Pvt Ltd.</span>
//                     </p>
//                 </div>
//             </div>
